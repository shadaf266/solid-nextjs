    ...
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-20 2xl:px-0">
          {/* <!-- Footer Top --> */}
          <div className="py-20 lg:py-8 lg:pt-28">
            <div className="flex flex-wrap flex-col gap-8 lg:justify-between lg:gap-0">
              {/* <motion.div
                variants={{
                  hidden: {
                    opacity: 0,
              ...
              <div className="flex w-full flex-col gap-8 md:flex-col md:center md:gap-0 lg:w-full xl:w-full">
              <motion.div
                  variants={{
                    hidden: {
                      opacity: 0,
                  ...
                  viewport={{ once: true }}
                  className="animate_top subscribe-section mb-9"
                >
                  ...
                  />
                      <input
                        ...
                        className="w-full rounded-full border border-stroke px-6 py-3 shadow-solid-11 focus:border-primary focus:outline-none dark:border-strokedark dark:bg-black dark:shadow-none newslater-wrapper dark:focus:border-primary"
                      />

                      <button
                        aria-label="signup to newsletter"
                        className="absolute right-0 p-4 bg-primery"
                      >
                       Subscribe
                      </button>
                    </div>
              ...
              <a href="index.html" className="relative footer-logo">
                  <Image
                    width={119}
                    height={30}
          ...
          {/* <!-- Footer Bottom --> */}
          <div className="flex flex-col  md:px-8 flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            <motion.div
              variants={{
                hidden: {
                  opacity: 0,
            ...
            <motion.div
              ...
              className="animate_top"
            >
              <p className="copyright-texts">
                &copy; {new Date().getFullYear()} Brand, Inc. Privacy.Terms.Sitemap
              </p>
            </motion.div>
            ...
            >
              ...
              <li>
                  <a href="#" aria-label="social icon">
                    <svg
                      className="fill-[#2EBAE8] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                <li>
                  <a href="#" aria-label="social icon">
                    <svg
                      className="fill-[#2E6FE8] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                <li>
                  <a href="#" aria-label="social icon">
                    <svg
                      className="fill-[#2148A5] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
